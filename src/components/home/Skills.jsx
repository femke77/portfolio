...
export default function Skills() {
  ...
  return (
      ...
      <Box id="skills"  ref={wrapperRef} style={{ overflow: "hidden", whiteSpace: "nowrap", marginTop: "25px" }} >
        {skills.map((skill, index) => (
              ...
              ref={el => (boxesRef.current[index] = el)}
                ...
                alt={skill.alt}
                title={skill.title}
                style={{ width: "125px", height: "100px", display: "inline-block" ,objectFit:"contain", backgroundColor: "transparent", margin: "15px" }}
              />
